...
import {IRUSDDataHub, IRUSDDataHubMainChain, PauseLevel} from "./interface/IRUSDDataHub.sol";
...
/**
 * @title RUSDDataHub
 * @notice The central registry and access control contract for the RUSD ecosystem.
 ...
 */
contract RUSDDataHub is IRUSDDataHub, UUPSUpgradeable, Base {
    /* ======== STATE ======== */
    ...
    address internal yusd; // yusd variable declared here to avoid slot collision on future upgrades
    ...
    /**
     * @notice Returns the RUSD address.
     */
...
/**
 * @title RUSDDataHubMainChain
 * @notice The main chain implementation of the RUSDDataHub contract. Only one instance of this contract is deployed on the main chain.
 * @dev Inherits from RUSDDataHub.
 * @dev Adding YUSD address.
 */
contract RUSDDataHubMainChain is IRUSDDataHubMainChain, RUSDDataHub {
    /**
     * @notice Returns the YUSD address.
     */
